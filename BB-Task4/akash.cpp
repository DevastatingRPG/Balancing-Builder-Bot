...
// //     if (btData == 'F') {
// //       Setpoint_Pitch = 1.1;  // Move forward
// //       moving = true;
// //       // doit = true;
// //     } else if (btData == 'S') {
// //       Setpoint_Pitch = -0.01;  // Move backward
// //       moving = true;
// //       // doit = true;
// //     } else if (btData == 'L') {
// //       moving = true;
...
//     if (btData == 'F') {
//       Setpoint_Pitch = 1.2;  // Move forward
//       moving = true;
//     } else if (btData == 'S') {
//       Setpoint_Pitch = -0.05;  // Move backward
//       moving = true;
//     } else if (btData == 'L') {
//       moving = true;
//       rotateMotor(255, -255);  // Rotate left
...
void loop()
{
    ...
    if (bluetooth.available())
    {
        ...
        if (btData == 'F')
        {
            Setpoint_Pitch = 1.7; // Move forward
            wheel_pulse_count_left = 0;
            wheel_pulse_count_right = 0;
            moving = true;
        }
