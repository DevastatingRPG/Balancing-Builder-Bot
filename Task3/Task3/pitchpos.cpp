...
PIDParams pitch1 = {80, 100, 0};
PIDParams pitch2 = {50, 40, 1};
PIDParams pos1 = {0.5, 0, 0};
...
void readEncoderTwo()
{
    int c = digitalRead(encA2);
    int d = digitalRead(encB2);
    if (d > c)
    {
        posiR++;
    }
...
void setup()
{
    ...
    digitalWrite(7, HIGH);
    digitalWrite(2, HIGH);
    attachInterrupt(digitalPinToInterrupt(2), readEncoderOne, RISING);

    digitalWrite(8, HIGH);
    digitalWrite(3, HIGH);
    attachInterrupt(digitalPinToInterrupt(3), readEncoderTwo, RISING);
...
void loop()
{
    ...
    */
    ...
    if (mpu.dmpGetCurrentFIFOPacket(FIFOBuffer))
    {
        ...
        //     }
        // }
        // if (abs(Error_Pitch) < 6)
        // {
        //     bluetooth.print(Output_Pitch);
        //     bluetooth.print(" ");
        //     bluetooth.println(Input_Pitch);
        // }
