...
def calculate_signed_distance(body_pos, cone_pos, setpoint_pos):
    """
    Calculate the signed Euclidean distance between body and setpoint positions.
...
def sysCall_sensing():
    ...
    setpoint_pos = self.setpoint_pos  # Assuming setpoint_pos is along the y-axis
    ...
    if message == sim.message_keypress:
        if data[0] == 2007:  # forward up arrow
            ...
            self.setpoint_pos = sim.getObjectPosition(self.body, -1)  # Assuming setpoint_pos is along the y-axis
