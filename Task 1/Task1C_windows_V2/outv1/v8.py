...
def sysCall_init():
    ...
    self.pid_pitch = PIDController(kp=40, ki=3, kd=1, dt=0.5, integral_limit=5, output_limit=20, derivative_filter=0.1)
...
def sysCall_actuation():
    ...
    #     if abs(vel) > 0.01:  # Threshold to stop deceleration
    #         vel *= 0.95  # Reduce velocity gradually
    #     else:
    #         vel = 0
...
def sysCall_sensing():
    ...
    vel_offset = 0.08
    deceleration_rate = 0.003  # Rate at which to decelerate
